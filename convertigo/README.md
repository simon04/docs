...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/convertigo/badge/icon) (`arm64v8/convertigo` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/convertigo/)
...
```console
$ docker run -d --name C8O-MBAAS -e JAVA_OPTS="-Xmx4096m -DjvmRoute=server1" -p 28080:28080 arm64v8/convertigo
```
